...
export default class Book_Page extends Component {
  ...
  get_book_data = ()=>{
    ...
    if (getUser()){
      ...
      axios.get(`http://${process.env.REACT_APP_PRODUCTION_IP}/rate/${getUser().userId}/${this.props.match.params.id}`)
      .then(res=>{
      ...
      axios.get(`http://${process.env.REACT_APP_PRODUCTION_IP}/userBook/${getUser().userId}/${this.props.match.params.id}`)
      .then(res=>{
  ...
  rate_book = () => {
    if (getUser()){
      axios.post(`http://${process.env.REACT_APP_PRODUCTION_IP}/rate/${getUser().userId}/${this.props.match.params.id}`,{
  ...
  changeState = async(event) => {
    if (getUser()){
      ...
      axios.put(`http://${process.env.REACT_APP_PRODUCTION_IP}/userBook/${getUser().userId}/${this.props.match.params.id}`,{action: event.target.value})
      .then(res=>{
      }).catch(err=>{
        console.log(err);
      })
  ...
  submitReview = () => {
    if (getUser()){
      axios.post(`http://${process.env.REACT_APP_PRODUCTION_IP}/review/${getUser().userId}/${this.props.match.params.id}`,{review: this.state.review})
      .then(res=>{
